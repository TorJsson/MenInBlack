...
public class AgentSokOmradeResultat extends javax.swing.JFrame {
    private static int id;
    private static int omradeId;

    public AgentSokOmradeResultat(int id, int omradeId) {
        initComponents();
        this.id = id;
    ...
    ArrayList<HashMap<String, String>> allaAgenter = Agent.getAllaNamnOchIdByOmrade(omradeId);
    ...
    private void btnRedigeraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRedigeraActionPerformed
        if(tblResultatLista.getSelectionModel().isSelectionEmpty()){
            ...
            if(tblResultatLista.getValueAt(tblResultatLista.getSelectedRow(), 1) == null) {
                JOptionPane.showMessageDialog(null, "Det finns ingen agent registrerad i det valda området.", "Ett fel har uppstått", JOptionPane.ERROR_MESSAGE);
            } else {
